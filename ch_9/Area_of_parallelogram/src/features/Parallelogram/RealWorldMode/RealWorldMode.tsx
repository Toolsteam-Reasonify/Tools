                ...
                <div className="flex-1 bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/30 shadow-lg">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-3">
                    <div className="bg-white/30 rounded-lg p-2 text-center">
                      <div className="text-xs text-white/80">{t('base')}</div>
                      <div className="font-bold text-white">{ex.base} {i < 3 ? t('m') : t('ft')}</div>
                    </div>
                    <div className="bg-white/30 rounded-lg p-2 text-center">
                      <div className="text-xs text-white/80">{t('height')}</div>
                      <div className="font-bold text-white">{ex.height} {i < 3 ? t('m') : t('ft')}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4 border-l-4 border-indigo-500">
                    <div className="flex items-start gap-2">
                      <span className="text-2xl">📊</span>
                      <div>
                        <h4 className="font-bold text-gray-800 mb-2">{t('solution')}</h4>
                        <p className="text-gray-700 font-medium">
                          {t('area')} = {t('base')} × {t('height')} = {ex.base} × {ex.height} = {ex.base * ex.height} {i < 3 ? t('sqM') : t('sqFt')}
                        </p>
                      </div>
                    </div>
                  </div>
