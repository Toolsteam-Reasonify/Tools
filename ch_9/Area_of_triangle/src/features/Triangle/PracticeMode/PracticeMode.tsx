...
import { TriangleExercise } from '../../../interfaces/triangleTypes';
...
export default function PracticeMode() {
  ...
  // Practice exercises based on images
  const exercises: TriangleExercise[] = [
    {
      id: 1,
      triangle: { base: 4, height: 3, color: '#3b82f6' },
    ...
    {
      id: 2,
      triangle: { base: 3.2, height: 5, color: '#8b5cf6' },
    ...
    {
      id: 3,
      triangle: { base: 3, height: 4, color: '#ec4899' },
    ...
    {
      id: 4,
      triangle: { base: 3, height: 2, color: '#10b981', isObtuse: true },
    ...
    {
      id: 5,
      triangle: { base: 24, height: 3, color: '#f59e0b' },
    ...
    {
      id: 6,
      triangle: { base: 4, height: 5, color: '#ef4444' },
          ...
          <div className="relative z-10">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl mb-6">
              <div className="text-center mb-4">
                <TriangleSVG 
                  base={currentEx.triangle.base} 
                  height={currentEx.triangle.height} 
                  showHeight={true}
                  color={currentEx.triangle.color}
                  isObtuse={currentEx.triangle.isObtuse}
                />
              </div>
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border-2 border-blue-300">
                  <div className="text-sm font-bold text-gray-700 mb-1">{t('base')}</div>
                  <div className="text-2xl font-bold text-blue-700">{currentEx.triangle.base} {t('cm')}</div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border-2 border-purple-300">
                  <div className="text-sm font-bold text-gray-700 mb-1">{t('height')}</div>
                  <div className="text-2xl font-bold text-purple-700">{currentEx.triangle.height} {t('cm')}</div>
                </div>
              </div>
            </div>
          </div>
