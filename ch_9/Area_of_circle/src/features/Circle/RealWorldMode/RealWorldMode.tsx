...
export default function RealWorldMode() {
  ...
  const examples = [
    { id: 1, title: t('ex1Title'), context: t('ex1Context'), question: t('ex1Question'), answer: t('ex1Answer'), icon: '🏃' },
    { id: 2, title: t('ex2Title'), context: t('ex2Context'), question: t('ex2Question'), answer: t('ex2Answer'), icon: '🪢' },
    { id: 3, title: t('ex3Title'), context: t('ex3Context'), question: t('ex3Question'), answer: t('ex3Answer'), icon: '🧼' },
    { id: 4, title: t('ex4Title'), context: t('ex4Context'), question: t('ex4Question'), answer: t('ex4Answer'), icon: '🚿' },
    { id: 5, title: t('ex5Title'), context: t('ex5Context'), question: t('ex5Question'), answer: t('ex5Answer'), icon: '🛞' },
    { id: 6, title: t('ex6Title'), context: t('ex6Context'), question: t('ex6Question'), answer: t('ex6Answer'), icon: '🕒' },
  ];
            ...
            <div className={`relative overflow-hidden bg-gradient-to-br ${gradients[i % gradients.length]} rounded-3xl p-6 shadow-xl border-2 ${borderColors[i % borderColors.length]} hover:shadow-2xl ${selected === i ? 'ring-4 ring-white scale-105' : ''}`}>
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <div className="flex-1 bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/30 shadow-lg">
                  <div className="flex items-start gap-2 mb-3"><span className="text-xl">📌</span><p className="text-sm text-white/90 leading-relaxed"><AnimatedText text={ex.context} /></p></div>
                </div>
              ...
              <div className="mt-4 bg-white rounded-2xl shadow-xl p-6 border-2 border-gray-200">
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 border-l-4 border-blue-500">
                    <div className="flex items-start gap-2"><span className="text-2xl">❓</span><div><h4 className="font-bold text-gray-800 mb-2">{t('questionLabel')}</h4><p className="text-gray-700"><AnimatedText text={ex.question} /></p></div></div>
                  </div>
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border-l-4 border-green-500">
                    <div className="flex items-start gap-2"><span className="text-2xl">✅</span><div><h4 className="font-bold text-gray-800 mb-2">{t('answerLabel')}</h4><p className="text-gray-700"><AnimatedText text={ex.answer} delay={200} /></p></div></div>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-700">
              <p className="flex items-start gap-2"><span className="text-xl">🏃</span><span>{t('whyMatterPoint1')}</span></p>
              <p className="flex items-start gap-2"><span className="text-xl">📚</span><span>{t('whyMatterPoint2')}</span></p>
              <p className="flex items-start gap-2"><span className="text-xl">📏</span><span>{t('whyMatterPoint3')}</span></p>
              <p className="flex items-start gap-2"><span className="text-xl">π</span><span>{t('whyMatterPoint4')}</span></p>
            </div>
          </div>
        </div>
      </div>
