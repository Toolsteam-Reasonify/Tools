...
export default function PracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { id: 'q1', promptKey: 'practice_q1', prompt: t('practice_q1'), answer: 25 }, // 1/4 = 25%
    { id: 'q2', promptKey: 'practice_q2', prompt: t('practice_q2'), answer: 60 }, // 3/5 = 60%
    { id: 'q3', promptKey: 'practice_q3', prompt: t('practice_q3'), answer: 75 }, // 0.75 = 75%
    { id: 'q4', promptKey: 'practice_q4', prompt: t('practice_q4'), answer: 60 }, // 0.6 = 60%
    { id: 'q5', promptKey: 'practice_q5', prompt: t('practice_q5'), answer: 60 }, // 60% = 3/5 (simplified)
    { id: 'q6', promptKey: 'practice_q6', prompt: t('practice_q6'), answer: 25 }, // 25% = 1/4 (simplified)
    { id: 'q7', promptKey: 'practice_q7', prompt: t('practice_q7'), answer: 40 }, // 8/20 = 40%
    { id: 'q8', promptKey: 'practice_q8', prompt: t('practice_q8'), answer: 50 }, // 15/30 = 50%
  ], [language, t]);
