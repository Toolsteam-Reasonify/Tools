...
function LinearEquationExample({ onSelectType }: { onSelectType: (t: 'interpret' | 'percent_of_total' | 'ratio_to_percent' | 'percent_change') => void }) {
  ...
  // Language-specific examples for Topic 7.4 (Simple Interest)
  const equationExamples = [
    { equation: "I = (5000 × 15 × 1)/100 = ₹750", solution: "₹750", operation: t('cpt_siOneYearTitle'), icon: "🧮" },
    { equation: "I = (3000 × 5 × 3)/100 = ₹450", solution: "₹450", operation: t('cpt_siMultiYearsTitle'), icon: "⏱️" }
  ];

  const currentExamples = equationExamples;
      ...
      <div className="text-center mb-6">
        ...
        <div className="space-y-3">
                  <p className={`text-gray-700 text-sm transition-all duration-1000 ease-out ${
                    ...
                    <AnimatedText text={t('demo_siDefinition')} delay={0} />
                  </p>
          ...
          <div className={`transition-all duration-1000 ease-out ${
            ...
            {language === 'hi' && (
              <div className="mt-3">
                <AnimatedText text={t('demo_siFormulaNote')} delay={0} />
              </div>
            )}
          </div>
                  ...
                  <p className={`text-gray-700 text-sm transition-all duration-1000 ease-out ${
                    ...
                    <AnimatedText text={t('demo_siUsage')} delay={0} />
                  </p>
        </div>
      </div>
