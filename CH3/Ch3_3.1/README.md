...
- i18next uses language detector (URL `?lang=hi`, localStorage, browser settings) with instant runtime switching.
...
- Missing key checker: `npm run i18n:missing` (compares `hi`/`gu` against `en` and logs gaps).
