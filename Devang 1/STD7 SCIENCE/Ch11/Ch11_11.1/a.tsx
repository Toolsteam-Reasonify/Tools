  ...
  return (
    <div
      style={{
        ...
        height,
        background:
          "linear-gradient(to bottom, #0f172a 0%, #1e1b4b 50%, #1e293b 100%)",
        borderRadius: 12,
        overflow: "hidden",
      }}
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "linear-gradient(135deg, #3b82f6 0%, #22c55e 40%, #3b82f6 100%)",
          overflow: "hidden",
        }}
      >
        <div
...
const SourcesOfLight: React.FC<SourcesOfLightProps> = ({
  ...
  const getModeColors = (m: ModeType, isActive: boolean) => {
    const colors = {
      learn: { bg: "#22c55e", light: "rgba(34, 197, 94, 0.2)" },
      practice: { bg: "#3b82f6", light: "rgba(59, 130, 246, 0.2)" },
      real_world: { bg: "#a855f7", light: "rgba(168, 85, 247, 0.2)" },
    };
    return isActive
      ? { background: colors[m].bg, color: "#fff" }
      : {
          background: darkMode ? colors[m].light : colors[m].light,
  ...
  const styles: { [key: string]: React.CSSProperties } = {
    ...
    title: {
      ...
      fontWeight: 700,
      background: "linear-gradient(90deg, #fcd34d, #f97316, #fcd34d)",
    ...
    animationBox: {
      background: darkMode ? "rgba(15, 23, 42, 0.6)" : "rgba(241,245,249,0.8)",
      borderRadius: isMobile ? 8 : 10,
        ...
        <div style={styles.contentInner}>
          ...
          {mode === "learn" && (
            <div style={styles.card}>
              ...
              >
                <IconBook size={isMobile ? 18 : 22} color="#22c55e" />
          ...
          {mode === "practice" && !quizComplete && (
            <div style={styles.card}>
              ...
              >
                <IconTarget size={isMobile ? 18 : 22} color="#3b82f6" />
                Practice Quiz
              </h2>
              <p
                style={{
                  ...
                  return (
                    ...
                    >
                      ...
                      {showExplanation && isCorrect && (
                        <IconCheck size={isMobile ? 16 : 20} color="#22c55e" />
                      )}
                      {showExplanation && isSelected && !isCorrect && (
                        <IconX size={isMobile ? 16 : 20} color="#ef4444" />
                      )}
                    </button>
                  );
                })}
              ...
              {showExplanation && (
                <div
                  style={{
                    ...
                    border: `1px solid ${selectedAnswer === quizQuestions[currentStep].correctAnswer ? "rgba(34,197,94,0.4)" : "rgba(251,146,60,0.4)"}`,
                  }}
                >
                  <p
                    style={{
          ...
          {mode === "real_world" && (
            <div style={styles.card}>
              ...
              >
                <IconGlobe size={isMobile ? 18 : 22} color="#a855f7" />
                Real World Examples
              </h2>
            ...
            style={{
              ...
              background:
                currentStep === 0
                  ...
                  : themeColor,
              color:
                currentStep === 0 ? (darkMode ? "#64748b" : "#94a3b8") : "#fff",
