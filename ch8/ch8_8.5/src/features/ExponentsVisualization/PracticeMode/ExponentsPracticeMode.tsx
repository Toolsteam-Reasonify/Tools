...
export default function ExponentsPracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { 
      ...
      prompt: t('q1_prompt'), 
      answer: '10⁴', 
      // Q1: Convert 10,000 to exponential form
      // Errors checked: All options are valid exponential forms. Correct answer is 10⁴.
      options: ['10²', '10³', '10⁴', '10⁵'],
    ...
    { 
      ...
      answer: '125', 
      // Q2: What is 5³?
      // Errors checked: 5³ = 125. Options include common mistakes: 15 (5+5+5), 25 (5²), 75 (wrong calculation). Correct: 125.
    ...
    { 
      ...
      prompt: t('q3_prompt'), 
      answer: '7', 
      // Q3: What is the base in 7⁴?
      // Errors checked: In 7⁴, base is 7, exponent is 4. Options: 4 (exponent - common mistake), 7 (correct), 11 (random), 28 (7×4 - common mistake)
      options: ['4', '7', '11', '28'],
    ...
    { 
      ...
      prompt: t('q4_prompt'), 
      answer: '5', 
      // Q4: What is the exponent in 2⁵?
      // Errors checked: In 2⁵, base is 2, exponent is 5. Options: 2 (base - common mistake), 5 (correct), 10 (2×5), 25 (5²)
      options: ['2', '5', '10', '25'],
    ...
    { 
      ...
      answer: '81', 
      // Q5: Calculate 3⁴
      // Errors checked: 3⁴ = 81. Options: 27 (3³ - common mistake), 64 (4³ or 8²), 81 (correct), 243 (3⁵ - common mistake)
    ...
    { 
      ...
      prompt: t('q6_prompt'), 
      answer: '10²', 
      // Q6: What is 100 in exponential form?
      // Errors checked: 100 = 10². Options are all valid exponential forms. Correct: 10².
      options: ['10¹', '10²', '10³', '10⁴'],
