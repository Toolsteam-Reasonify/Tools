  ...
  const applications = [
    {
      ...
      examplePoints: [
        { num: -5, den: 1, label: '−5°C (Leh) — left of 0 (scaled to range)' },
        { num: 4, den: 1, label: '+10°C (Delhi) — right of 0 (scaled to +4)' }
      ]
    },
    {
      id: 'banking',
      icon: '🏦',
      title: t('rw_app_banking_title'),
      description: t('rw_app_banking_desc'),
      color: 'from-green-500 to-teal-500',
      bgColor: 'from-green-100 via-teal-50 to-green-100',
      borderColor: 'border-green-400',
      examplePoints: [
        { num: 2, den: 1, label: '+₹2000 (shown at +2)' },
        { num: -2, den: 1, label: '−₹1500 (shown at −2)' }
      ]
    },
    {
      id: 'seaLevel',
      icon: '🌊',
      title: t('rw_app_sea_title'),
      description: t('rw_app_sea_desc'),
      color: 'from-cyan-500 to-sky-500',
      bgColor: 'from-cyan-100 via-sky-50 to-cyan-100',
      borderColor: 'border-cyan-400',
      examplePoints: [
        { num: -3, den: 1, label: '−300 m (shown at −3)' },
        { num: 1, den: 1, label: '+100 m (shown at +1)' }
      ]
    },
    {
      id: 'debtCredit',
      ...
      examplePoints: [
        { num: -1, den: 1, label: '−₹500 (−1)' },
        { num: 2, den: 1, label: '+₹1000 (+2)' }
      ]
    },
    {
      id: 'weatherChange',
      icon: '☁️',
      title: t('rw_app_weather_title'),
      description: t('rw_app_weather_desc'),
      color: 'from-indigo-500 to-purple-500',
      bgColor: 'from-indigo-100 via-purple-50 to-indigo-100',
      borderColor: 'border-indigo-400',
      examplePoints: [
        { num: 8, den: 1, label: '+8°C (clamped to +4)' },
        { num: 4, den: 1, label: 'After drop: +4°C' }
      ]
    },
    {
      id: 'airplane',
      icon: '✈️',
      title: t('rw_app_airplane_title'),
      description: t('rw_app_airplane_desc'),
      color: 'from-pink-500 to-rose-500',
      bgColor: 'from-pink-100 via-rose-50 to-pink-100',
      borderColor: 'border-pink-400',
      examplePoints: [
        { num: 3, den: 1, label: '+3000 m (shown at +3)' },
        { num: 1, den: 1, label: '+1500 m (shown at +1)' }
      ]
    },
  ];
