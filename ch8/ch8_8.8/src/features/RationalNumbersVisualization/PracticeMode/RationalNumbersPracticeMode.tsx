...
export default function RationalNumbersPracticeMode() {
  ...
  const examples = [
    { 
      q: 'Convert 36/24 to standard form', 
      a: '3/2 (divide numerator and denominator by 12)',
      num: 36,
      den: 24,
      icon: '🔢'
    },
    ...
    { 
      q: 'Find a rational between -1 and 0', 
      a: '-1/2 is a valid choice',
      num: -1,
      den: 2,
      icon: '🔍'
    },
    { 
      q: 'Convert -15/20 to standard form', 
      a: '-3/4 (make denominator positive, divide by HCF 5)',
      num: -15,
      den: 20,
      icon: '⚡'
    },
        ...
        >
          <div className="flex items-center justify-center gap-4 sm:gap-5 md:gap-6 lg:gap-8 mb-6 px-6 sm:px-8 md:px-12 lg:px-16 w-full max-w-7xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 bg-clip-text text-transparent leading-[1.3] px-6 sm:px-8 md:px-12 lg:px-16 break-words w-full max-w-7xl mx-auto py-3"
            >
              {t('rn_practiceHeader')}
            </motion.h1>
            <motion.div
...
function PracticeFlow() {
  ...
  const questions: Q[] = [
    {
      id: 'q1',
      prompt: t('pq88_1_prompt'),
      options: [t('pq88_1_opt1'), t('pq88_1_opt2'), t('pq88_1_opt3'), t('pq88_1_opt4')],
      correct: 3,
      explain: t('pq88_1_explain')
    },
    {
      id: 'q2',
      prompt: t('pq88_2_prompt'),
      options: [t('pq88_2_opt1'), t('pq88_2_opt2'), t('pq88_2_opt3'), t('pq88_2_opt4')],
      correct: 1,
      explain: t('pq88_2_explain'),
      num: 5,
      den: 8
    },
    {
      id: 'q3',
      prompt: t('pq88_3_prompt'),
      options: [t('pq88_3_opt1'), t('pq88_3_opt2'), t('pq88_3_opt3'), t('pq88_3_opt4')],
      correct: 1,
      explain: t('pq88_3_explain')
    },
    {
      id: 'q4',
      prompt: t('pq88_4_prompt'),
      options: [t('pq88_4_opt1'), t('pq88_4_opt2'), t('pq88_4_opt3'), t('pq88_4_opt4')],
      correct: 1,
      explain: t('pq88_4_explain')
    },
    {
      id: 'q5',
      prompt: t('pq88_5_prompt'),
      options: [t('pq88_5_opt1'), t('pq88_5_opt2'), t('pq88_5_opt3'), t('pq88_5_opt4')],
      correct: 1,
      explain: t('pq88_5_explain'),
      num: -8,
      den: 15
    },
    {
      id: 'q6',
      prompt: t('pq88_6_prompt'),
      options: [t('pq88_6_opt1'), t('pq88_6_opt2'), t('pq88_6_opt3'), t('pq88_6_opt4')],
      correct: 2,
      explain: t('pq88_6_explain')
    },
  ];
  ...
  const submit = () => {
    ...
    setChecked(prev => ({ ...prev, [current.id]: { chosen: selected, correct: isCorrect, skipped: false, timeMs: elapsed } }));
  };
...
function StandardFormConverter() {
