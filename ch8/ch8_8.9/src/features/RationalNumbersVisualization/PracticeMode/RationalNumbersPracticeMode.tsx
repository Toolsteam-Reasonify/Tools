        ...
        >
          <div className="flex items-center justify-center gap-4 sm:gap-5 md:gap-6 lg:gap-8 mb-6 px-6 sm:px-8 md:px-12 lg:px-16 w-full max-w-7xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 bg-clip-text text-transparent leading-[1.3] px-4 sm:px-6 md:px-8 break-words w-full max-w-7xl mx-auto py-3"
            >
              {t('rn_practiceHeader')}
            </motion.h1>
            <motion.div
...
function PracticeFlow() {
  ...
  const questions: Q[] = [
    {
      id: 'q1',
      prompt: t('pq89_1_prompt'),
      options: [t('pq89_1_opt1'), t('pq89_1_opt2'), t('pq89_1_opt3'), t('pq89_1_opt4')],
      correct: 2,
      explain: t('pq89_1_explain'),
      num: 1,
      den: 1
    },
    {
      id: 'q2',
      prompt: t('pq89_2_prompt'),
      options: [t('pq89_2_opt1'), t('pq89_2_opt2'), t('pq89_2_opt3'), t('pq89_2_opt4')],
      correct: 1,
      explain: t('pq89_2_explain'),
      num: 7,
      den: 12
    },
    {
      id: 'q3',
      prompt: t('pq89_3_prompt'),
      options: [t('pq89_3_opt1'), t('pq89_3_opt2'), t('pq89_3_opt3'), t('pq89_3_opt4')],
      correct: 0,
      explain: t('pq89_3_explain'),
      num: -2,
      den: 5
    },
    {
      id: 'q4',
      prompt: t('pq89_4_prompt'),
      options: [t('pq89_4_opt1'), t('pq89_4_opt2'), t('pq89_4_opt3'), t('pq89_4_opt4')],
      correct: 0,
      explain: t('pq89_4_explain'),
      num: 8,
      den: 15
    },
    {
      id: 'q5',
      prompt: t('pq89_5_prompt'),
      options: [t('pq89_5_opt1'), t('pq89_5_opt2'), t('pq89_5_opt3'), t('pq89_5_opt4')],
      correct: 0,
      explain: t('pq89_5_explain'),
      num: 7,
      den: 9
    },
    {
      id: 'q6',
      prompt: t('pq89_6_prompt'),
      options: [t('pq89_6_opt1'), t('pq89_6_opt2'), t('pq89_6_opt3'), t('pq89_6_opt4')],
      correct: 0,
      explain: t('pq89_6_explain'),
      num: -8,
      den: 5
    },
  ];
