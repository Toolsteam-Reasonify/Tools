  ...
  const applications = [
    {
      id: 'shopping',
      icon: '🛒',
      title: t('rw89_shopping_title'),
      description: t('rw89_shopping_desc'),
      color: 'from-blue-500 to-cyan-500',
      bgColor: 'from-blue-100 via-cyan-50 to-blue-100',
      borderColor: 'border-blue-400',
      examplePoints: [
        { num: 75, den: 10, label: '₹7.5 (initial)' },
        { num: 625, den: 100, label: '₹6.25 (after discount)' },
        { num: 7, den: 1, label: '₹7.00 (final)' }
      ]
    },
    {
      id: 'cooking',
      icon: '🍳',
      title: t('rw89_cooking_title'),
      description: t('rw89_cooking_desc'),
      color: 'from-orange-500 to-red-500',
      bgColor: 'from-orange-100 via-red-50 to-orange-100',
      borderColor: 'border-orange-400',
      examplePoints: [
        { num: 2, den: 3, label: '2/3 cup (4 people)' },
        { num: 3, den: 2, label: 'Scaling factor: 3/2' },
        { num: 1, den: 1, label: '1 cup (6 people)' }
      ]
    },
    {
      id: 'distance',
      icon: '🚶',
      title: t('rw89_distance_title'),
      description: t('rw89_distance_desc'),
      color: 'from-green-500 to-emerald-500',
      bgColor: 'from-green-100 via-emerald-50 to-green-100',
      borderColor: 'border-green-400',
      examplePoints: [
        { num: 3, den: 4, label: '3/4 km north' },
        { num: -1, den: 2, label: '−1/2 km (south)' },
        { num: 1, den: 4, label: '1/4 km from start' }
      ]
    },
    {
      id: 'time',
      icon: '⏰',
      title: t('rw89_time_title'),
      description: t('rw89_time_desc'),
      color: 'from-purple-500 to-indigo-500',
      bgColor: 'from-purple-100 via-indigo-50 to-purple-100',
      borderColor: 'border-purple-400',
      examplePoints: [
        { num: 3, den: 2, label: '1.5 hours (study)' },
        { num: 3, den: 4, label: '0.75 hours (exercise)' },
        { num: 7, den: 2, label: '3.5 hours total' }
      ]
    },
    {
      id: 'stock',
      icon: '📈',
      title: t('rw89_stock_title'),
      description: t('rw89_stock_desc'),
      color: 'from-pink-500 to-rose-500',
      bgColor: 'from-pink-100 via-rose-50 to-pink-100',
      borderColor: 'border-pink-400',
      examplePoints: [
        { num: 1125, den: 10, label: '₹112.50 (after gain)' },
        { num: 10375, den: 100, label: '₹103.75 (after loss)' },
        { num: 375, den: 100, label: '+₹3.75 (net change)' }
      ]
    },
    {
      id: 'fraction',
      icon: '🔨',
      title: t('rw89_fraction_title'),
      description: t('rw89_fraction_desc'),
      color: 'from-yellow-500 to-amber-500',
      bgColor: 'from-yellow-100 via-amber-50 to-yellow-100',
      borderColor: 'border-yellow-400',
      examplePoints: [
        { num: 2, den: 5, label: '2/5 (Person A)' },
        { num: 1, den: 3, label: '1/3 (Person B)' },
        { num: 4, den: 15, label: '4/15 remaining' }
      ]
    },
  ];
