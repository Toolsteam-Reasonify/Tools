...
export default function TransportControls({ onPrev, onNext, onPlayPause, isPlaying }: Props) {
  ...
  return (
    <div className={`flex items-center gap-3 transition-all duration-300 ${
      ...
      {/* Previous Button */}
      <button 
        className={`group relative px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-400/50 ${
          activeButton === 'prev' 
