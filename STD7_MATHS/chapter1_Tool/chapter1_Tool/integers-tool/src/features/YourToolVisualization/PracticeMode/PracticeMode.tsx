...
export default function PracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { id: 'q1', promptKey: 'practice_q1', prompt: 'Evaluate: (-6) + 9', answer: 3 },
    { id: 'q2', promptKey: 'practice_q2', prompt: 'Evaluate: 12 - (-5)', answer: 17 },
    { id: 'q3', promptKey: 'practice_q3', prompt: 'Evaluate: (-8) - 7', answer: -15 },
    { id: 'q4', promptKey: 'practice_q4', prompt: 'Evaluate: 4 + (-4)', answer: 0 },
    { id: 'q5', promptKey: 'practice_q5', prompt: 'Evaluate: (-10) + 7', answer: -3 },
    { id: 'q6', promptKey: 'practice_q6', prompt: 'Evaluate: 15 - 20', answer: -5 },
  ], []);
