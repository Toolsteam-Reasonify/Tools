...
export default function PracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { id: 'q1', promptKey: 'practice_q1', prompt: t('practice_q1'), answer: 750 },   // I for P=5000,R=15%,T=1
    { id: 'q2', promptKey: 'practice_q2', prompt: t('practice_q2'), answer: 5750 }, // A for P=5000, I=750
    { id: 'q3', promptKey: 'practice_q3', prompt: t('practice_q3'), answer: 160 },  // I for P=2000,R=8%,T=1
    { id: 'q4', promptKey: 'practice_q4', prompt: t('practice_q4'), answer: 450 },  // I for P=3000,R=5%,T=3
    { id: 'q5', promptKey: 'practice_q5', prompt: t('practice_q5'), answer: 10 },   // 10% of 100
    { id: 'q6', promptKey: 'practice_q6', prompt: t('practice_q6'), answer: 4480 }, // A for P=4000,R=6%,T=2
    { id: 'q7', promptKey: 'practice_q7', prompt: t('practice_q7'), answer: 2 },    // T from I=600,P=3000,R=10
    { id: 'q8', promptKey: 'practice_q8', prompt: t('practice_q8'), answer: 10 },   // R from I=900,P=3000,T=3
  ], [language, t]);
