...
export default function PracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    // Topic 1: Profit Calculation (2 questions)
    { id: 'q1', promptKey: 'practice_q1', prompt: t('practice_q1'), answer: 20 }, // CP=₹100, SP=₹120, Profit=₹20
    { id: 'q2', promptKey: 'practice_q2', prompt: t('practice_q2'), answer: 50 }, // CP=₹250, SP=₹300, Profit=₹50
    
    // Topic 2: Loss Calculation (2 questions)
    { id: 'q3', promptKey: 'practice_q3', prompt: t('practice_q3'), answer: 30 }, // CP=₹150, SP=₹120, Loss=₹30
    { id: 'q4', promptKey: 'practice_q4', prompt: t('practice_q4'), answer: 50 }, // CP=₹400, SP=₹350, Loss=₹50
    
    // Topic 3: Profit Percentage (2 questions)
    { id: 'q5', promptKey: 'practice_q5', prompt: t('practice_q5'), answer: 20 }, // CP=₹200, Profit=₹40, Profit%=20%
    { id: 'q6', promptKey: 'practice_q6', prompt: t('practice_q6'), answer: 15 }, // CP=₹500, Profit=₹75, Profit%=15%
    
    // Topic 4: Loss Percentage (2 questions)
    { id: 'q7', promptKey: 'practice_q7', prompt: t('practice_q7'), answer: 15 }, // CP=₹300, Loss=₹45, Loss%=15%
    { id: 'q8', promptKey: 'practice_q8', prompt: t('practice_q8'), answer: 15 }, // CP=₹600, Loss=₹90, Loss%=15%
  ], [language, t]);
