...
// Visual percentage conversion data with icons and colors
const equationTypes: EquationType[] = [
  {
    ...
    steps: [
      ...
      '1/4 × 100 = 25%',
      'Answer: 1/4 = 25%',
      'Check: 25% means 25 out of 100 ✓'
    ],
    translations: {
      gu: { 
        name: 'અપૂર્ણાંકથી ટકાવારી', 
        rule: '100 વડે ગુણો', 
        description: 'અપૂર્ણાંકને ટકાવારીમાં રૂપાંતરિત કરવું',
        steps: [
          'શરૂ કરો: 1/4 = ?%',
          'અપૂર્ણાંકને ટકાવારીમાં રૂપાંતરિત કરવા માટે, 100 વડે ગુણો',
          '1/4 × 100 = 25%',
          'જવાબ: 1/4 = 25%',
          'તપાસો: 25% નો અર્થ 100 માંથી 25 ✓'
        ]
      },
      hi: { 
        name: 'भिन्न से प्रतिशत', 
        rule: '100 से गुणा करें', 
        description: 'भिन्न को प्रतिशत में बदलना',
        steps: [
          'शुरू करें: 1/4 = ?%',
          'भिन्न को प्रतिशत में बदलने के लिए, 100 से गुणा करें',
          '1/4 × 100 = 25%',
          'उत्तर: 1/4 = 25%',
          'जांचें: 25% का मतलब 100 में से 25 ✓'
        ]
      }
    }
  },
  {
    ...
    solution: '75%',
    rule: 'Multiply by 100',
    description: 'Converting decimals to percentages',
    icon: '📈',
    color: 'bg-green-500',
    steps: [
      'Start with: 0.75 = ?%',
      ...
      '0.75 × 100 = 75%',
      'Answer: 0.75 = 75%',
      'Check: 75% means 75 out of 100 ✓'
    ],
    translations: {
      gu: { 
        name: 'દશાંશથી ટકાવારી', 
        rule: '100 વડે ગુણો', 
        description: 'દશાંશને ટકાવારીમાં રૂપાંતરિત કરવું',
        steps: [
          'શરૂ કરો: 0.75 = ?%',
          'દશાંશને ટકાવારીમાં રૂપાંતરિત કરવા માટે, 100 વડે ગુણો',
          '0.75 × 100 = 75%',
          'જવાબ: 0.75 = 75%',
          'તપાસો: 75% નો અર્થ 100 માંથી 75 ✓'
        ]
      },
      hi: { 
        name: 'दशमलव से प्रतिशत', 
        rule: '100 से गुणा करें', 
        description: 'दशमलव को प्रतिशत में बदलना',
        steps: [
          'शुरू करें: 0.75 = ?%',
          'दशमलव को प्रतिशत में बदलने के लिए, 100 से गुणा करें',
          '0.75 × 100 = 75%',
          'उत्तर: 0.75 = 75%',
          'जांचें: 75% का मतलब 100 में से 75 ✓'
        ]
      }
    }
  },
  {
    ...
    equation: '60% = ?',
    solution: '3/5',
    rule: 'Divide by 100 and simplify',
    ...
    translations: {
      gu: { 
        name: 'ટકાવારીથી અપૂર્ણાંક', 
        rule: '100 વડે ભાગો અને સરળ બનાવો', 
        description: 'ટકાવારીને અપૂર્ણાંકમાં રૂપાંતરિત કરવું',
        steps: [
          'શરૂ કરો: 60% = ?',
          'ટકાવારીને અપૂર્ણાંકમાં રૂપાંતરિત કરવા માટે, 100 વડે ભાગો',
          '60% = 60/100',
          'સરળ બનાવો: 60/100 = 6/10 = 3/5',
          'જવાબ: 60% = 3/5 ✓'
        ]
      },
      hi: { 
        name: 'प्रतिशत से भिन्न', 
        rule: '100 से भाग दें और सरल करें', 
        description: 'प्रतिशत को भिन्न में बदलना',
        steps: [
          'शुरू करें: 60% = ?',
          'प्रतिशत को भिन्न में बदलने के लिए, 100 से भाग दें',
          '60% = 60/100',
          'सरल करें: 60/100 = 6/10 = 3/5',
          'उत्तर: 60% = 3/5 ✓'
        ]
      }
    }
...
const SimpleEquationsTool: React.FC = () => {
  ...
  const [selectedEquation, setSelectedEquation] = useState<string>('fraction_to_percentage');
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { id: 'q1', promptKey: 'practice_q1', prompt: 'Convert 1/4 to percentage', answer: '25%' },
    { id: 'q2', promptKey: 'practice_q2', prompt: 'Convert 0.6 to percentage', answer: '60%' },
    { id: 'q3', promptKey: 'practice_q3', prompt: 'Convert 3/5 to percentage', answer: '60%' },
    { id: 'q4', promptKey: 'practice_q4', prompt: 'Convert 0.25 to percentage', answer: '25%' },
    { id: 'q5', promptKey: 'practice_q5', prompt: 'Convert 1/2 to percentage', answer: '50%' },
    { id: 'q6', promptKey: 'practice_q6', prompt: 'Convert 0.8 to percentage', answer: '80%' },
  ], []);
      ...
      <div className="space-y-6 transition-all duration-500 ease-out">
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center gap-4 mb-4">
            ...
            <label className="text-lg font-semibold text-gray-700">Select Conversion Type</label>
          </div>
          <select
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-purple-50 rounded-xl p-6 border border-teal-200">
              <div className="text-center mb-4">
                <div className="text-lg font-semibold text-gray-800">Step-by-Step Conversion</div>
              </div>
