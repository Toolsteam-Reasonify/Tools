...
export default function PracticeMode() {
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    // Topic 1: Interpret % Statement (2 questions)
    { id: 'q1', promptKey: 'practice_q1', prompt: t('practice_q1'), answer: 10 }, // 25% of 40 children = 10
    { id: 'q2', promptKey: 'practice_q2', prompt: t('practice_q2'), answer: 30 }, // 20% of 150 dresses = 30
    
    // Topic 2: % of a Total (2 questions)
    { id: 'q3', promptKey: 'practice_q3', prompt: t('practice_q3'), answer: 300 }, // 15% of ₹2000 = ₹300
    { id: 'q4', promptKey: 'practice_q4', prompt: t('practice_q4'), answer: 24 }, // 30% of 80 students = 24
    
    // Topic 3: Ratio → % (2 questions)
    { id: 'q5', promptKey: 'practice_q5', prompt: t('practice_q5'), answer: 60 }, // 3:2 ratio = 60% sugar
    { id: 'q6', promptKey: 'practice_q6', prompt: t('practice_q6'), answer: 80 }, // 4:1 ratio = 80% water
    
    // Topic 4: % Change (2 questions)
    { id: 'q7', promptKey: 'practice_q7', prompt: t('practice_q7'), answer: 25 }, // ₹280→₹350 = 25% increase
    { id: 'q8', promptKey: 'practice_q8', prompt: t('practice_q8'), answer: 20 }, // ₹500→₹400 = 20% decrease
  ], [language, t]);
