...
export default function RealWorldMode() {
  ...
  // 6 Real-world examples - using translations
  const examples = [
    {
      id: 1,
      title: t('ex1Title'),
      context: t('ex1Context'),
      problem: t('ex1Question'),
      answer: t('ex1Answer'),
      calculation: t('ex1Calculation'),
      icon: '🛒',
    },
    {
      id: 2,
      ...
      problem: t('ex2Question'),
      answer: t('ex2Answer'),
      calculation: t('ex2Calculation'),
      icon: '📐',
    },
    {
      id: 3,
      ...
      problem: t('ex3Question'),
      answer: t('ex3Answer'),
      calculation: t('ex3Calculation'),
      icon: '🚗',
    },
    {
      id: 4,
      ...
      problem: t('ex4Question'),
      answer: t('ex4Answer'),
      calculation: t('ex4Calculation'),
      icon: '🔷',
    },
    {
      id: 5,
      ...
      problem: t('ex5Question'),
      answer: t('ex5Answer'),
      calculation: t('ex5Calculation'),
      icon: '🏎️',
    },
    {
      id: 6,
      ...
      problem: t('ex6Question'),
      answer: t('ex6Answer'),
      calculation: t('ex6Calculation'),
      icon: '✂️',
    },
  ];
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-4 border-l-4 border-yellow-500">
                    <div className="flex items-start gap-2">
                      <span className="text-2xl">🧮</span>
                      <div>
                        <h4 className="font-bold text-gray-800 mb-2">Calculation</h4>
