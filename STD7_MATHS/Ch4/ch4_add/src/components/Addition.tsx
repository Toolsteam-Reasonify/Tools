...
// Basic Types (from src/types/index.ts)
...
// Simple Equations Types (from src/interfaces/simpleEquationsTypes.ts)
...
export interface SimpleEquationsProps {
  ...
  onProgress?: (progress: ProgressDataExtended) => void;
...
// Progress tracking (extended version)
export interface ProgressDataExtended {
  current_step: number;
  total_steps: number;
...
function DemoStep({ title, description, example, isActive = true, stepNumber }: DemoStepProps) {
...
function StepByStepExplanation() {
  ...
  // Language-specific step explanations for addition example: x + 5 = 12
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          step: "Step 4:",
          equation: "7 + 5 = 12",
          explanation: "Check: Substitute x = 7 back into original equation"
        },
        {
          step: "Step 5:",
          equation: "12 = 12 ✓",
    ...
    hi: {
      ...
      steps: [
        ...
        },
        {
          step: "चरण 2:",
          equation: "x + 5 - 5 = 12 - 5",
          explanation: "x को अलग करने के लिए दोनों तरफ से 5 घटाएं"
        },
        {
          step: "चरण 3:",
          equation: "x = 7",
        ...
        },
        {
          step: "चरण 4:",
          equation: "7 + 5 = 12",
          explanation: "जांच: x = 7 को मूल समीकरण में रखें"
        },
        {
          step: "चरण 5:",
          equation: "12 = 12 ✓",
    ...
    gu: {
      ...
      steps: [
        ...
        },
        {
          step: "પગલું 2:",
          equation: "x + 5 - 5 = 12 - 5",
          explanation: "x ને અલગ કરવા માટે બંને બાજુથી 5 બાદ કરો"
        },
        {
          step: "પગલું 3:",
          equation: "x = 7",
        ...
        },
        {
          step: "પગલું 4:",
          equation: "7 + 5 = 12",
          explanation: "તપાસ: x = 7 ને મૂળ સમીકરણમાં મૂકો"
        },
        {
          step: "પગલું 5:",
          equation: "12 = 12 ✓",
...
// PracticeExerciseCard Component (from PracticeMode folder)
...
// ResetButton Component (from SharedControls)
type ResetButtonProps = {
  onReset?: () => void;
};

function ResetButtonShared({ onReset }: ResetButtonProps) {
...
function TransportControlsShared({ onPrev, onNext, onPlayPause, isPlaying }: TransportControlsProps) {
  const { isTransitioning, t } = useLanguage();
  const [activeButton, setActiveButton] = useState<string | null>(null);
