import React, { Component, ErrorInfo, ReactNode, useState, useEffect, useMemo, createContext, useContext, useCallback } from 'react';
...
const translations = {
  en: {
    ...
    simpleEquations: 'Simple Equations - Division',
    simpleEquationsTitle: 'Simple Equations - Division',
    ...
    // Practice Questions
    practice_q1: 'Solve: x ÷ 3 = 5',
    practice_q2: 'Solve: x ÷ 4 = 3',
    practice_q3: 'Solve: x ÷ 7 = 3',
    practice_q4: 'Solve: x ÷ 2 = 4',
    practice_q5: 'Solve: x ÷ 5 = 2',
    practice_q6: 'Solve: x ÷ 3 = 3',
    practice_q7: 'Solve: x ÷ 6 = 3',
    practice_q8: 'Solve: x ÷ 2 = 3',
    practice_q9: 'Solve: x ÷ 8 = 4',
    practice_q10: 'Solve: x ÷ 7 = 2',
    practice_q11: 'Solve: x ÷ 3 = 2',
    practice_q12: 'Solve: x ÷ 12 = 2'
  },
  hi: {
    // Navigation
    home: 'होम',
    ...
    simpleEquations: 'सरल समीकरण - भाग',
    simpleEquationsTitle: 'सरल समीकरण - भाग',
    ...
    // Practice Questions
    practice_q1: 'हल करें: x ÷ 3 = 5',
    practice_q2: 'हल करें: x ÷ 4 = 3',
    practice_q3: 'हल करें: x ÷ 7 = 3',
    practice_q4: 'हल करें: x ÷ 2 = 4',
    practice_q5: 'हल करें: x ÷ 5 = 2',
    practice_q6: 'हल करें: x ÷ 3 = 3',
    practice_q7: 'हल करें: x ÷ 6 = 3',
    practice_q8: 'हल करें: x ÷ 2 = 3',
    practice_q9: 'हल करें: x ÷ 8 = 4',
    practice_q10: 'हल करें: x ÷ 7 = 2',
    practice_q11: 'हल करें: x ÷ 3 = 2',
    practice_q12: 'हल करें: x ÷ 12 = 2'
  },
  gu: {
    // Navigation
    home: 'ઘર',
    ...
    simpleEquations: 'સરળ સમીકરણો - ભાગાકાર',
    simpleEquationsTitle: 'સરળ સમીકરણો - ભાગાકાર',
    ...
    // Practice Questions
    practice_q1: 'હલ કરો: x ÷ 3 = 5',
    practice_q2: 'હલ કરો: x ÷ 4 = 3',
    practice_q3: 'હલ કરો: x ÷ 7 = 3',
    practice_q4: 'હલ કરો: x ÷ 2 = 4',
    practice_q5: 'હલ કરો: x ÷ 5 = 2',
    practice_q6: 'હલ કરો: x ÷ 3 = 3',
    practice_q7: 'હલ કરો: x ÷ 6 = 3',
    practice_q8: 'હલ કરો: x ÷ 2 = 3',
    practice_q9: 'હલ કરો: x ÷ 8 = 4',
    practice_q10: 'હલ કરો: x ÷ 7 = 2',
    practice_q11: 'હલ કરો: x ÷ 3 = 2',
    practice_q12: 'હલ કરો: x ÷ 12 = 2'
  }
};
...
// Type definitions for SimpleEquationsTool
...
const equationTypes: EquationType[] = [
  {
    ...
    solution: '12',
    rule: 'Multiply by 4',
    description: 'Simple division equations',
    icon: '➗',
    color: 'bg-teal-500',
    steps: [
      'Start with: x ÷ 4 = 3',
    ...
    translations: {
      gu: { 
        name: 'સરળ ભાગાકાર', 
        rule: '4 થી ગુણો', 
        description: 'સરળ ભાગાકાર સમીકરણો',
        steps: [
          'શરૂ કરો: x ÷ 4 = 3',
          'x ને અલગ કરવા માટે, બંને બાજુથી 4 થી ગુણો',
          'x ÷ 4 × 4 = 3 × 4',
          'સરળ બનાવો: x = 12',
          'તપાસો: 12 ÷ 4 = 3 ✓'
        ]
      ...
      hi: { 
        name: 'सरल भाग', 
        rule: '4 से गुणा करें', 
        description: 'सरल भाग के समीकरण',
        steps: [
          'शुरू करें: x ÷ 4 = 3',
          'x को अलग करने के लिए, दोनों तरफ 4 से गुणा करें',
          'x ÷ 4 × 4 = 3 × 4',
          'सरल करें: x = 12',
          'जांचें: 12 ÷ 4 = 3 ✓'
        ]
  ...
  {
    id: 'division_with_addition',
    name: 'Division with Addition',
    equation: 'x ÷ 3 + 2 = 7',
    solution: '15',
    rule: 'Subtract 2, then multiply by 3',
    description: 'Division equations with addition',
    icon: '➗',
    color: 'bg-blue-500',
    steps: [
      'Start with: x ÷ 3 + 2 = 7',
    ...
    translations: {
      gu: { 
        name: 'સરવાળા સાથે ભાગાકાર', 
        rule: '2 બાદ કરો, પછી 3 થી ગુણો', 
        description: 'સરવાળા સાથે ભાગાકાર સમીકરણો',
        steps: [
          'શરૂ કરો: x ÷ 3 + 2 = 7',
          'પગલું 1: બંને બાજુથી 2 બાદ કરો',
          'x ÷ 3 + 2 - 2 = 7 - 2',
          'સરળ બનાવો: x ÷ 3 = 5',
          'પગલું 2: બંને બાજુથી 3 થી ગુણો',
          'x ÷ 3 × 3 = 5 × 3',
          'અંતિમ જવાબ: x = 15',
          'તપાસો: 15 ÷ 3 + 2 = 7 ✓'
        ]
      ...
      hi: { 
        name: 'जोड़ के साथ भाग', 
        rule: '2 घटाएं, फिर 3 से गुणा करें', 
        description: 'जोड़ के साथ भाग के समीकरण',
        steps: [
          'शुरू करें: x ÷ 3 + 2 = 7',
          'चरण 1: दोनों तरफ से 2 घटाएं',
          'x ÷ 3 + 2 - 2 = 7 - 2',
          'सरल करें: x ÷ 3 = 5',
          'चरण 2: दोनों तरफ 3 से गुणा करें',
          'x ÷ 3 × 3 = 5 × 3',
          'अंतिम उत्तर: x = 15',
          'जांचें: 15 ÷ 3 + 2 = 7 ✓'
        ]
  ...
  {
    id: 'division_word_problem',
    name: 'Division Word Problem',
    equation: 'x ÷ 6 = 4',
    solution: '24',
    rule: 'Multiply by 6',
    description: 'Real-world division problems',
    icon: '📝',
    color: 'bg-purple-500',
    steps: [
      'Start with: x ÷ 6 = 4',
    ...
    translations: {
      gu: { 
        name: 'ભાગાકાર શબ્દ સમસ્યા', 
        rule: '6 થી ગુણો', 
        description: 'વાસ્તવિક જગતની ભાગાકાર સમસ્યાઓ',
        steps: [
          'શરૂ કરો: x ÷ 6 = 4',
          'x ને અલગ કરવા માટે, બંને બાજુથી 6 થી ગુણો',
          'x ÷ 6 × 6 = 4 × 6',
          'સરળ બનાવો: x = 24',
          'તપાસો: 24 ÷ 6 = 4 ✓'
        ]
      ...
      hi: { 
        name: 'भाग शब्द समस्या', 
        rule: '6 से गुणा करें', 
        description: 'वास्तविक दुनिया की भाग की समस्याएं',
        steps: [
          'शुरू करें: x ÷ 6 = 4',
          'x को अलग करने के लिए, दोनों तरफ 6 से गुणा करें',
          'x ÷ 6 × 6 = 4 × 6',
          'सरल करें: x = 24',
          'जांचें: 24 ÷ 6 = 4 ✓'
        ]
...
const SimpleEquationsTool: React.FC = () => {
  ...
  const [selectedEquation, setSelectedEquation] = useState<string>('simple_division');
  ...
  const baseExercises = useMemo<Omit<Exercise, 'attempted' | 'correct' | 'skipped'>[]>(() => [
    { id: 'q1', promptKey: 'practice_q1', prompt: 'Solve: x ÷ 4 = 3', answer: '12' },
    { id: 'q2', promptKey: 'practice_q2', prompt: 'Solve: y ÷ 5 = 4', answer: '20' },
    { id: 'q3', promptKey: 'practice_q3', prompt: 'Solve: x ÷ 3 + 2 = 7', answer: '15' },
    { id: 'q4', promptKey: 'practice_q4', prompt: 'Solve: z ÷ 6 = 4', answer: '24' },
    { id: 'q5', promptKey: 'practice_q5', prompt: 'Solve: a ÷ 2 + 3 = 8', answer: '10' },
    { id: 'q6', promptKey: 'practice_q6', prompt: 'Solve: b ÷ 7 = 3', answer: '21' },
  ], []);
...
function StepByStepExplanation() {
  ...
  // Language-specific step explanations for division example: x/4 = 3
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          step: "Step 2:",
          equation: "x/4 × 4 = 3 × 4",
          explanation: "Multiply both sides by 4 to isolate x"
        },
        {
          step: "Step 3:",
          equation: "x = 12",
    ...
    hi: {
      ...
      steps: [
        ...
        },
        {
          step: "चरण 2:",
          equation: "x/4 × 4 = 3 × 4",
          explanation: "x को अलग करने के लिए दोनों तरफ को 4 से गुणा करें"
        },
        {
          step: "चरण 3:",
          equation: "x = 12",
    ...
    gu: {
      ...
      steps: [
        ...
        },
        {
          step: "પગલું 2:",
          equation: "x/4 × 4 = 3 × 4",
          explanation: "x ને અલગ કરવા માટે બંને બાજુઓને 4 વડે ગુણો"
        },
        {
          step: "પગલું 3:",
          equation: "x = 12",
...
function PracticeModeComponent() {
  const { t, language } = useLanguage();
  ...
  function onResult(ok: boolean) {
    ...
    // Record the attempt
    const attempt: PracticeQuestionAttempt = {
      questionId: currentExercise.id,
      answer: ok ? 'correct' : 'incorrect',
      isCorrect: ok,
      attempts: 1,
...
function PracticeExerciseCardComponent({ 
  prompt, 
  answer, 
  onResult,
  questionNumber,
...
function SharedResetButton({ onReset }: ResetButtonProps) {
...
function SharedTransportControls({ onPrev, onNext, onPlayPause, isPlaying }: TransportControlsProps) {
  const { isTransitioning, t } = useLanguage();
...
function SharedSimpleTransportControls({ onPrev, onNext }: SimpleTransportControlsProps) {
  const { isTransitioning, t } = useLanguage();
  const [activeButton, setActiveButton] = useState<string | null>(null);
...
export const practiceProblems: Problem[] = [
  {
    ...
    equation: 'x ÷ 3 = 5',
    solution: '15',
    explanation: 'Multiply both sides by 3: x ÷ 3 × 3 = 5 × 3, so x = 15'
  },
  {
    id: 2,
    equation: 'y ÷ 4 = 3',
    solution: '12',
    explanation: 'Multiply both sides by 4: y ÷ 4 × 4 = 3 × 4, so y = 12'
  },
  {
    id: 3,
    equation: 'z ÷ 7 = 3',
    solution: '21',
    explanation: 'Multiply both sides by 7: z ÷ 7 × 7 = 3 × 7, so z = 21'
  },
  {
    id: 4,
    equation: 'w ÷ 2 = 4',
    solution: '8',
    explanation: 'Multiply both sides by 2: w ÷ 2 × 2 = 4 × 2, so w = 8'
  },
  {
    id: 5,
    equation: 'a ÷ 5 = 2',
    solution: '10',
    explanation: 'Multiply both sides by 5: a ÷ 5 × 5 = 2 × 5, so a = 10'
  },
  {
    id: 6,
    equation: 'b ÷ 3 = 3',
    solution: '9',
    explanation: 'Multiply both sides by 3: b ÷ 3 × 3 = 3 × 3, so b = 9'
  },
  {
    id: 7,
    equation: 'c ÷ 6 = 3',
    solution: '18',
    explanation: 'Multiply both sides by 6: c ÷ 6 × 6 = 3 × 6, so c = 18'
  },
  {
    id: 8,
    equation: 'd ÷ 2 = 3',
    solution: '6',
    explanation: 'Multiply both sides by 2: d ÷ 2 × 2 = 3 × 2, so d = 6'
  },
  {
    id: 9,
    equation: 'e ÷ 8 = 4',
    solution: '32',
    explanation: 'Multiply both sides by 8: e ÷ 8 × 8 = 4 × 8, so e = 32'
  },
  {
    id: 10,
    equation: 'f ÷ 7 = 2',
    solution: '14',
    explanation: 'Multiply both sides by 7: f ÷ 7 × 7 = 2 × 7, so f = 14'
  },
  {
    id: 11,
    equation: 'x ÷ 3 = 2',
    solution: '6',
    explanation: 'Multiply both sides by 3: x ÷ 3 × 3 = 2 × 3, so x = 6'
  },
  {
    id: 12,
    equation: 'y ÷ 12 = 2',
    solution: '24',
    explanation: 'Multiply both sides by 12: y ÷ 12 × 12 = 2 × 12, so y = 24'
  },
  {
    id: 13,
    equation: 'z ÷ 9 = 3',
    solution: '27',
    explanation: 'Multiply both sides by 9: z ÷ 9 × 9 = 3 × 9, so z = 27'
  },
  {
    id: 14,
    equation: 'w ÷ 5 = 4',
  ...
  },
  {
    ...
    equation: 'a ÷ 6 = 5',
    solution: '30',
    explanation: 'Multiply both sides by 6: a ÷ 6 × 6 = 5 × 6, so a = 30'
  }
];
...
export const assessmentQuestions = [
  ...
  {
    id: 3,
    question: 'What is the solution to z ÷ 7 = 3?',
    options: ['18', '20', '21', '24'],
    correct: '21',
    explanation: 'Multiply both sides by 7: z ÷ 7 × 7 = 3 × 7, so z = 21'
  },
  {
    id: 4,
    question: 'Find the value of w in w ÷ 2 = 4',
    options: ['6', '8', '10', '12'],
    correct: '8',
    explanation: 'Multiply both sides by 2: w ÷ 2 × 2 = 4 × 2, so w = 8'
  },
  ...
  {
    id: 6,
    question: 'What is the value of x in the equation x ÷ 3 = 3?',
    options: ['6', '9', '12', '15'],
    correct: '9',
    explanation: 'Multiply both sides by 3: x ÷ 3 × 3 = 3 × 3, so x = 9'
  },
  {
    id: 7,
    question: 'Solve for y: y ÷ 6 = 3',
    options: ['15', '18', '21', '24'],
    correct: '18',
    explanation: 'Multiply both sides by 6: y ÷ 6 × 6 = 3 × 6, so y = 18'
  },
  {
    id: 8,
    question: 'Find the value of z in z ÷ 2 = 3',
    options: ['4', '6', '8', '10'],
    correct: '6',
    explanation: 'Multiply both sides by 2: z ÷ 2 × 2 = 3 × 2, so z = 6'
  },
  {
    id: 9,
    question: 'Solve: w ÷ 8 = 4',
    options: ['28', '30', '32', '36'],
    correct: '32',
    explanation: 'Multiply both sides by 8: w ÷ 8 × 8 = 4 × 8, so w = 32'
  },
  {
    id: 10,
    question: 'What is the solution to a ÷ 7 = 2?',
    options: ['12', '14', '16', '18'],
    correct: '14',
    explanation: 'Multiply both sides by 7: a ÷ 7 × 7 = 2 × 7, so a = 14'
  },
  {
    id: 11,
    question: 'Solve for b: b ÷ 3 = 2',
    options: ['4', '6', '8', '10'],
    correct: '6',
    explanation: 'Multiply both sides by 3: b ÷ 3 × 3 = 2 × 3, so b = 6'
  },
  {
    id: 12,
    question: 'Find the value of x in x ÷ 12 = 2',
    options: ['20', '22', '24', '26'],
    correct: '24',
    explanation: 'Multiply both sides by 12: x ÷ 12 × 12 = 2 × 12, so x = 24'
  },
  {
    id: 13,
    question: 'Solve: y ÷ 9 = 3',
    options: ['24', '27', '30', '33'],
    correct: '27',
    explanation: 'Multiply both sides by 9: y ÷ 9 × 9 = 3 × 9, so y = 27'
  },
  {
    id: 14,
    question: 'What is the value of z in z ÷ 5 = 4?',
    options: ['18', '20', '22', '24'],
    correct: '20',
    explanation: 'Multiply both sides by 5: z ÷ 5 × 5 = 4 × 5, so z = 20'
  },
  {
    id: 15,
    question: 'Solve: w ÷ 6 = 5',
    options: ['28', '30', '32', '36'],
    correct: '30',
    explanation: 'Multiply both sides by 6: w ÷ 6 × 6 = 5 × 6, so w = 30'
  }
];
...
export interface SimpleEquationsPracticeExercise {
  exercise_id: string;
  title: string;
  description: string;
  difficulty: 'beginner' | 'intermediate' | 'advanced';
...
export interface SimpleEquationsData {
  ...
  // Practice data
  practice?: {
    exercises: SimpleEquationsPracticeExercise[];
    session_config: {
...
const PracticePage = () => {
  return <PracticeModeComponent />
}

interface RealWorldApplicationData {
  id: string;
  title: string;
  description: string;
  equation: string;
...
const realWorldApplications: RealWorldApplicationData[] = [
  {
    id: 'shopping_budget',
...
const RealWorldApplications: React.FC = () => {
  const { language, t } = useLanguage();
  const [selectedApp, setSelectedApp] = useState<RealWorldApplicationData | null>(null);
  ...
  const renderApplicationCard = (app: RealWorldApplicationData) => {
    const appData = {
      ...app,
  ...
  const renderApplicationDetail = (app: RealWorldApplicationData) => {
    const appData = {
      ...app,
      title: getTranslatedText(app, 'title', language),
      description: getTranslatedText(app, 'description', language),
...
export { ErrorBoundary, Navigation, Layout, SimpleEquationsTool, DemonstrationMode, PracticeModeComponent, PracticeExerciseCardComponent, SharedResetButton, SharedModeSwitcher, SharedTransportControls, SharedSimpleTransportControls, LearnPage, PracticePage, RealWorldApplications };
