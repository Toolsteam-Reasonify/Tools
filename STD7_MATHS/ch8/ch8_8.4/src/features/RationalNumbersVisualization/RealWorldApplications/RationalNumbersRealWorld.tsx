  ...
  const applications = [
    {
      id: 'bank',
      icon: '🏦',
      title: t('rw_app_bank_title'),
      description: t('rw_app_bank_desc'),
      color: 'from-blue-500 to-cyan-500',
      bgColor: 'from-blue-100 via-cyan-50 to-blue-100',
      borderColor: 'border-blue-400',
      examplePoints: [
        { num: 5, den: 1, label: '+₹500 (deposit, shown at +5)' },
        { num: -3, den: 1, label: '−₹320 (withdrawal, shown at −3)' }
      ]
    },
    {
      id: 'lift',
      icon: '🛗',
      title: t('rw_app_lift_title'),
      description: t('rw_app_lift_desc'),
      color: 'from-green-500 to-teal-500',
      bgColor: 'from-green-100 via-teal-50 to-green-100',
      borderColor: 'border-green-400',
      examplePoints: [
        { num: 8, den: 1, label: '+8th floor (shown at +4)' },
        { num: -2, den: 1, label: '−2 parking level (shown at −2)' }
      ]
    },
    {
      id: 'stock',
      icon: '📈',
      title: t('rw_app_stock_title'),
      description: t('rw_app_stock_desc'),
      color: 'from-cyan-500 to-sky-500',
      bgColor: 'from-cyan-100 via-sky-50 to-cyan-100',
      borderColor: 'border-cyan-400',
      examplePoints: [
        { num: 45, den: 10, label: '+₹45 (gain, shown at +4.5)' },
        { num: -28, den: 10, label: '−₹28 (loss, shown at −2.8)' }
      ]
    },
    {
      id: 'debt',
      icon: '💼',
      title: t('rw_app_debt_title'),
      description: t('rw_app_debt_desc'),
      color: 'from-yellow-500 to-orange-500',
      bgColor: 'from-yellow-100 via-orange-50 to-yellow-100',
      borderColor: 'border-yellow-400',
      examplePoints: [
        { num: 30, den: 1, label: '+₹3000 (received, shown at +3)' },
        { num: -18, den: 1, label: '−₹1800 (paid, shown at −1.8)' }
      ]
    },
    {
      id: 'altitude',
      ...
      examplePoints: [
        { num: 25, den: 1, label: '+2500 m (peak, shown at +2.5)' },
        { num: -4, den: 1, label: '−400 m (valley, shown at −0.4)' }
      ]
    },
    {
      id: 'quiz',
      icon: '📝',
      title: t('rw_app_quiz_title'),
      description: t('rw_app_quiz_desc'),
      color: 'from-pink-500 to-rose-500',
      bgColor: 'from-pink-100 via-rose-50 to-pink-100',
      borderColor: 'border-pink-400',
      examplePoints: [
        { num: 8, den: 1, label: '+8 points (correct)' },
        { num: -3, den: 1, label: '−3 points (wrong)' }
      ]
    },
  ];
