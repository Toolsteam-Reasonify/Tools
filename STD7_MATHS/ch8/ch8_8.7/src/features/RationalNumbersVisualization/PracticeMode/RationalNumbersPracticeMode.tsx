  ...
  const questions: Q[] = [
    {
      ...
      correct: 1, // 3/4 is greater than 2/3
    ...
    },
    {
      ...
      correct: 0, // -7/5 is greater than -5/3 (reverse when negative)
    ...
    },
    {
      ...
      correct: 0, // -1/5 is greater than -1/2
    ...
    },
    {
      ...
      correct: 1, // -3/5 < 2/7 (after converting -2/-7 to 2/7)
    ...
    },
    {
      ...
      correct: 1, // Rightmost number is greater
