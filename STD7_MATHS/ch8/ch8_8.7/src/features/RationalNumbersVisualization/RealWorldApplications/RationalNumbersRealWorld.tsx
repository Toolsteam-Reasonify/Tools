  ...
  const applications = [
    {
      id: 'temperatureComp',
      icon: '🌡️',
      title: t('rw_app_temperature_comp_title'),
      description: t('rw_app_temperature_comp_desc'),
      color: 'from-blue-500 to-cyan-500',
      bgColor: 'from-blue-100 via-cyan-50 to-blue-100',
      borderColor: 'border-blue-400',
      examplePoints: [
        { num: -5, den: 1, label: '-5°C (coldest)' },
        { num: -2, den: 1, label: '-2°C (cold)' },
        { num: 0, den: 1, label: '0°C' },
        { num: 3, den: 1, label: '3°C (warm)' }
      ]
    },
    {
      id: 'depth',
      icon: '🌊',
      title: t('rw_app_depth_title'),
      description: t('rw_app_depth_desc'),
      color: 'from-cyan-500 to-sky-500',
      bgColor: 'from-cyan-100 via-sky-50 to-cyan-100',
      borderColor: 'border-cyan-400',
      examplePoints: [
        { num: -3, den: 1, label: '-300m (deeper)' },
        { num: -2, den: 1, label: '-150m (closer)' },
        { num: 0, den: 1, label: '0m (sea level)' }
      ]
    },
    {
      id: 'score',
      ...
      examplePoints: [
        { num: -2, den: 1, label: '-2 (under par)' },
        { num: 0, den: 1, label: '0 (par)' },
        { num: 3, den: 1, label: '+3 (over par)' }
      ]
    },
    {
      id: 'finance',
      icon: '💰',
      title: t('rw_app_finance_title'),
      description: t('rw_app_finance_desc'),
      color: 'from-yellow-500 to-orange-500',
      bgColor: 'from-yellow-100 via-orange-50 to-yellow-100',
      borderColor: 'border-yellow-400',
      examplePoints: [
        { num: -5, den: 10, label: '-₹500 (debt)' },
        { num: 0, den: 1, label: '₹0 (zero)' },
        { num: 1, den: 1, label: '₹1000 (credit)' }
      ]
    },
    {
      id: 'elevation',
      icon: '⛰️',
      title: t('rw_app_elevation_title'),
      description: t('rw_app_elevation_desc'),
      color: 'from-purple-500 to-pink-500',
      bgColor: 'from-purple-100 via-pink-50 to-purple-100',
      borderColor: 'border-purple-400',
      examplePoints: [
        { num: -2, den: 1, label: '-200m (valley)' },
        { num: 0, den: 1, label: '0m (sea level)' },
        { num: 5, den: 1, label: '+500m (hill)' }
      ]
    },
    {
      id: 'profit',
      icon: '📊',
      title: t('rw_app_profit_title'),
      description: t('rw_app_profit_desc'),
      color: 'from-indigo-500 to-purple-500',
      bgColor: 'from-indigo-100 via-purple-50 to-indigo-100',
      borderColor: 'border-indigo-400',
      examplePoints: [
        { num: -5, den: 1, label: '-₹5000 (loss)' },
        { num: -2, den: 1, label: '-₹2000 (smaller loss)' },
        { num: 0, den: 1, label: '₹0' },
        { num: 3, den: 1, label: '+₹3000 (profit)' }
      ]
    },
  ];
