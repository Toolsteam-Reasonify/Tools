  ...
  const applications = [
    {
      ...
      examplePoints: [
        { num: -3, den: 1, label: '−3°C (left of 0)' },
        { num: 3, den: 1, label: '+3°C (right of 0)' }
      ]
    },
    {
      id: 'recipe',
      ...
      examplePoints: [
        { num: 3, den: 4, label: '+3/4 m above normal' },
        { num: -3, den: 4, label: '-3/4 m below normal' }
      ]
    },
    {
      id: 'distance',
      ...
      examplePoints: [
        { num: -3, den: 2, label: '-3/2 km west' },
        { num: 3, den: 2, label: '+3/2 km east' }
      ]
    },
    {
      id: 'altitude',
      ...
      examplePoints: [
        { num: -1, den: 2, label: '-1/2 km below sea level' },
        { num: 1, den: 2, label: '+1/2 km above sea level' }
      ]
    },
    {
      id: 'money',
      ...
      examplePoints: [
        { num: 5, den: 2, label: '+5/2 thousand ₹ (credit)' },
        { num: -5, den: 2, label: '-5/2 thousand ₹ (debt)' }
      ]
    },
    {
      id: 'time',
      ...
      examplePoints: [
        { num: -5, den: 2, label: '-5/2 hours behind GMT' },
        { num: 5, den: 2, label: '+5/2 hours ahead GMT' }
      ]
    },
  ];
